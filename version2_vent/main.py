...
VERSION : 2 (Modèle Avancé avec Vent)
AUTEURS : AUTEURS : Semih ASLAN, Rodanim GANABA, Christ BAHOUASSILA
"""
...
def main():
    print("PROJET PERCOLATION - VERSION 2")
